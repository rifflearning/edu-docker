...
MM_PKGS=( build-essential libjpeg-dev libpng-dev libtiff-dev libgif-dev libelf1 git )
DEV_PKGS=( vim-tiny )
...
# Install node --set up the apt repository to get the latest node ver ${NODE_VER}
